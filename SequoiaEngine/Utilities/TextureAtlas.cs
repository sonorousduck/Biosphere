...
{ 
    public class TextureAtlas
    {
        ...
        public static TextureAtlas Create(string name, Texture2D texture, int regionWidth, int regionHeight, int maxRegionCount = int.MaxValue, Vector2? margin = null, Vector2? spacing = null)
        {
